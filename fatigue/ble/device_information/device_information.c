...
static const uint8_t * MANUFACTURER_NAME_STRING_STRING = (uint8_t *)"FatigueSense";
static const uint8_t * MODEL_NUMBER_STRING_STRING = (uint8_t *)"xxxx";
static const uint8_t * SERIAL_NUMBER_STRING_STRING = (uint8_t *)"xxxx";
static const uint8_t * HARDWARE_REVISION_STRING_STRING = (uint8_t *)"0.1.0";
static const uint8_t * FIRMWARE_REVISION_STRING_STRING = (uint8_t *)"0.1.0";
static const uint8_t * SOFTWARE_REVISION_STRING_STRING = (uint8_t *)"0.1.0";
